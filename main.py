...
for i in range(epochs):
    ...
    while not done or steps < 1000:
        ...
        logits, value, tokens, world_model_loss = model(obs, tokens)
        ...
        dones.append(done)
        losses.append(world_model_loss)
    ...
    actor_loss, critic_loss, world_model_loss = model.calc_loss(
        actions, rewards, dones, values, losses)
    ...
    writer.add_scalar("Total Loss", actor_loss +
                      critic_loss + world_model_loss, i)
